...
venue: "School of Chemistry: Python and Unix Shell"        # brief name of host site without address (e.g., "Euphoric State University")
address: "Joseph Black building T40 and G.09, Kings Buildingings"      # full street address of workshop (e.g., "Room A, 123 Forth Street, Blimingen, Euphoria")
...
humantime: "9:00 pm - 1:00 pm (Thursday) and  9:00 pm - 5:00 pm (Friday)"    # human-readable times for the workshop (e.g., "9:00 am - 4:30 pm")
...
helper: ["Salome Llabres", "Mario Antonioletti", "David McKain", "Jenke Scheen", "Sophia Birmiami"]     # boxed, comma-separated list of helpers' names, like ["Marlyn Wescoff", "Fran Bilas", "Ruth Lichterman"]
